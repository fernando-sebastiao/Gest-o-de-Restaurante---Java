...
public class PesquisarAgendamento extends JFrame
{
    ...
    {
        super("Pesquisas do Agendamento");
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            {    
                if(centro.getTipoPesquisa() == 1)
                    AgendamentoFile.pesquisarPorId(centro.getIdProcurado());
                else if(centro.getTipoPesquisa() == 2)
                    AgendamentoFile.pesquisarPorData(centro.getDataProcurada());
            }
            else 
                dispose();
        }
